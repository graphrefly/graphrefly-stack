...
4. Continue automatically into the next canonical phase after its gate passes and the sequencer advances. Never skip a gate or select deferred work merely because no implementation phase is ready.
