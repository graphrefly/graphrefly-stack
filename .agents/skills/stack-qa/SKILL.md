---
name: stack-qa
description: Perform the single GraphReFly Stack quality gate combining adversarial code review, correctness fixes, tests, deterministic semantic evidence and GateResult validation, security/privacy review, UX and demo blockers, and submission readiness. Use after implementation, before marking a STACK phase done, for review or QA requests, and before demos, deployment, or submission.
---
...
1. Read `docs/sources.jsonl`, the changed phase and its gate, locked decisions, product scope and
   contracts, antipatterns, evidence requirements, and Build Week rules relevant to the milestone.
